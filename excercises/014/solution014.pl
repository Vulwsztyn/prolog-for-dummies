...
% I really hope it's self explanatory
...
% append_to_list_by_key(+Value: char, +Key: char, +InputList: [][char,List], -OutputList: [][char,List])
...
test_append_to_list_by_key(X) :- append_to_list_by_key(d,b,[[a,[1,2,3]],[b,[12]],[c,[]]],X).
% X = [[a, [1, 2, 3]], [b, [12, d]], [c, []]] - sorry za mismatch typów CBA
